...
public class WaitList<E> implements IWaitList<E>, I2WaitList<E>{
	...
	/**
	 * Return true if and only if this WaitListride a method in a parent interface or class for this
	// warning to go away. contains element.
	 * 
	 * @param element
